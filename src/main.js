...
import { printDataCharacters } from "./data.js";
import sortFunction from "./data.js";
...
createFilms(data);
createVehicles(data);
printDataCharacters(dataGhibli, charactersRoot);
...
filter.addEventListener("change", function () {
  ...
  if (selectedValue === "ascendant-name-order") {
    sortFunction.sortAToZTitle(data);
  } else if (selectedValue === "descendant-name-order") {
    sortFunction.sortZToATitle(data);
  } else if (selectedValue === "ascendant-date-order") {
    sortFunction.sortRDAsc(data);
  } else if (selectedValue === "descendant-date-order") {
    sortFunction.sortRDDesc(data);
  }
  createFilms(data);
});

/*const filter1 = document.getElementById('ascendant-name-order')
